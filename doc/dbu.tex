...
@sp 4
@center Tenth Edition (revised and with additions for WFDB library version 10.2.3)
@center @today
@sp 5
...
revisions for release 10.2.3 of the WFDB library.
@end ifinfo
...
Portability fixes in @code{wfdblib.h}.  (WFDB library version 10.2.2 was
identical to 10.2.1.)
