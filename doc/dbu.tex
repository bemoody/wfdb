...
Copyright @copyright{} 1989 -- 2000 George B. Moody
@sp 2
...
The latest version of the WFDB Software Package can always be downloaded
in source form from PhysioNet (@file{http://www.physionet.org/});  binaries
for popular operating systems and development snapshots are also usually
available for downloading there.  Earlier versions were included on the
second and third editions of the MIT-BIH Arrhythmia Database CD-ROM.
For information on obtaining the latest version of the WFDB Software Package
on CD-ROM, @pxref{Sources}.
...
If you are installing the software from a CD-ROM, copy the contents of the
@file{src/wfdb} directory to your hard disk.  Note that the text files are in
...
@file{u2d.exe} (available from PhysioNet or on the CD-ROM) to reformat the
...
text files yourself, which may be done under MS-DOS a PC using @file{u2m.exe},
or on a Macintosh using third-party software.  Additional notes for Macintosh
users may be found in file @file{MAC} (within the @file{wfdb} directory).
...
in Cambridge, Massachusetts in 2000, and in Rotterdam in 2001.
...
e-mail: @code{info@@calderasystems.com}
WWW: @code{http://www.calderasystems.com/}
...
WWW: @code{http://linux.corel.com/}
telephone: +1 613 728 0826
...
e-mail: @code{info@@slackware.com}, @code{info@@cdrom.com}
WWW: @code{http://www.slackware.com/}, @code{http://www.cdrom.com/}
