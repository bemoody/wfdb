...
visit
\begin{htmlonly}
\htmladdnormallink{PhysioNet}{http://www.physionet.org/}, or write to:
\end{htmlonly}
\begin{latexonly}
...
\htmladdnormallink{MIT}{http://www.physionet.org/}.  Printed
\end{htmlonly}
\begin{latexonly}
\noindent
...
otherwise; see the discussion of the database path in the
...
\end{latexonly}
\begin{figure}
\centerline{\epsfig{file=main-window.ps}}
...
will appear.
\begin{figure}
\centerline{\epsfig{file=find-window.ps}}
...
\end{latexonly}
Within the {\sf Find} window are three text fields in which you may type.  Move
...
Search for} field, and enter `{\tt A}' (followed, as always, by
...
\mbox{\epsfig{file=file-print.ps}}
\end{wrapfigure}
...
\begin{figure}
\fbox{\centerline{\epsfig{file=chart1.ps,angle=-90,width=.9\linewidth}}}
...
\end{latexonly}
\label{fig:spot-help}
\centerline{\epsfig{file=spot-help.ps}}
...
\begin{figure}
\centerline{\epsfig{file=help-topics.ps}}
...
\begin{figure}
\centerline{\epsfig{file=help-intro.ps}}
...
\mbox{\epsfig{file=notice-quit.ps}}
\end{wrapfigure}
...
\mbox{\epsfig{file=file-analyze.ps}}
\end{wrapfigure}
...
\begin{figure}
\centerline{\epsfig{file=analyze-window.ps}}
...
\begin{figure}
\centerline{\epsfig{file=analysis-commands.ps}}
...
File menu.
\begin{figure}
\centerline{\epsfig{file=load-window.ps}}
...
\begin{figure}
\centerline{\epsfig{file=annotation-template.ps}}
...
\begin{figure}
\centerline{\epsfig{file=type-menu.ps}}
...
\mbox{\epsfig{file=allow-edit.ps}}
\begin{htmlonly}
...
\begin{figure}
\centerline{\epsfig{file=main-with-markers.ps}}
...
\begin{figure}
\centerline{\epsfig{file=view-window.ps}}
...
\mbox{\epsfig{file=title-with-parens.ps}}
\begin{htmlonly}
...
\begin{figure}
\centerline{\epsfig{file=search-template.ps}}
...
\mbox{\epsfig{file=attach-to-signals.ps}}
\end{wrapfigure}
...
\mbox{\epsfig{file=system-menu.ps}}
\end{wrapfigure}
...
\begin{figure}
\centerline{\epsfig{file=wave-menu.ps}}
...
heart rate signal.
\begin{figure}
\centerline{\epsfig{file=main-with-hr.ps}}
...
\end{latexonly}
\centerline{\epsfig{file=log-window.ps}}
...
\mbox{\epsfig{file=scope-window.ps}}
...
output (see
\htmladdnormallink{{\tt plt(1)}}{../dbag/plt-1.htm}, in the
\htmladdnormallink{{\it WFDB Applications Guide}}{../dbag/dbag.htm},
...
\begin{figure}
\centerline{\epsfig{file=stdev.ps}}
...
You can set up your browser to view files with the suffix {\tt .xws} (or
the MIME type {\tt application/x-wavescript}) using {\tt wavescript}.  To
do so, add the line
\begin{verbatim}
...
your browser is Netscape 4.x, you can make these additions to {\tt
.mime.types} and {\tt .mailcap} by choosing {\sf Preferences}
from the Edit menu, opening the {\sf Navigator} category in the
{\sf Preferences} window, selecting {\sf Applications}, then
clicking on the {\sf New...} button.  Fill in the dialog box as shown in
figure~\ref{fig:netscape-new-helper}, then save your settings.  (Other
versions of Netscape have similar dialog boxes, and similar operations
may be possible with other browsers;  consult your browser's documentation.)
\begin{figure}
\centerline{\epsfig{file=netscape-new-helper.ps}}
...
anonymous FTP from
\htmladdnormallink{{\tt ftp.netscape.com}}{ftp://ftp.netscape.com/}).
...
\begin{figure}
\begin{latexonly}
\fbox{\centerline{\epsfig{file=chart2.ps,width=.9\linewidth}}}
\end{latexonly}
\begin{htmlonly}
........................................................................_
\end{htmlonly}
...
\begin{figure}
\begin{latexonly}
\fbox{\centerline{\epsfig{file=fulldisc.ps,width=.9\linewidth}}}
\end{latexonly}
\begin{htmlonly}
........................................................................_
\end{htmlonly}
...
respectively.
\begin{figure}
\centerline{\epsfig{file=calibrate.ps}}
...
\htmladdnormallink{{\tt calsig(1)}}{../dbag/calibr-1.htm},
in the
\htmladdnormallink{{\it WFDB Applications Guide}}{../dbag/dbag.htm}.
...
\begin{figure}[h]
\centerline{\epsfig{file=main-control-panel.ps}}
\end{figure}
...
\begin{figure}[h]
\centerline{\epsfig{file=print-setup-window.ps}}
\end{figure}
...
\begin{figure}[h]
\centerline{\epsfig{file=level-window.ps}}
\end{figure}
...
\begin{wrapfigure}{l}{2cm}
\mbox{\epsfig{file=scope-window.ps,bbllx=279,bblly=390,bburx=333,bbury=530,clip=}}
\end{wrapfigure}
...
(one for which a binary version of \WAVE{} is available).  Virtually any PC
with a 386 or better CPU can run Linux, and such systems are likely to be the
least expensive choice.  Ideally, a Linux PC to be used as a \WAVE{} host
should have at least 8 Mb of RAM, at least 200 Mb of available disk space, a
three-button mouse (or trackball), and a graphics card and monitor (17-inch or
larger, with a dot pitch of .26 mm or less) capable of non-interlaced display
at 65 Hz or faster with a resolution of at least 1024x768 with 256 colors.  In
most cases, you will also want the system to be equipped with a CD-ROM drive
(for loading software and digitized signals) and an Ethernet adapter or a
modem.  Check the Linux Hardware-HOWTO to be sure that your chosen hardware is
supported.  Most graphics cards, including the popular accelerated cards, are
fully supported by the standard XFree86 X server, but a few high-end models are
supported only in SVGA compatibility mode.  Most PCs manufactured since 1995
will easily meet these requirements; new PCs will exceed most of them by large
factors.  In late 2001, it was possible to assemble a suitable Linux PC for
about US\$500 (not including the monitor).  It is not unreasonable to budget an
equal amount for a good monitor, since \WAVE{}'s usability depends to a
...
very stable images that do not tire the eye.
...
{sec:adc-boards}).
Large collections of digitized reference recordings of ECGs and
other signals are freely available from
...
\index{Linux}\index{X Window System!XFree86 server} For many users seeking to
...
\htmladdnormallink{{\tt metalab.unc.edu}}{ftp://metalab.unc.edu/pub/Linux}, and
...
(\htmladdnormallink{{\tt http://www.linuxdoc.org/}}
...
\htmladdnormallink{sources}{http://www.physionet.org/physiotools/wfdb/wave/}
...
\htmladdnormallink{{\tt www.gnuplot.vt.edu}}{http://www.gnuplot.vt.edu/} and
numerous other sites.
\htmladdnormallink{{\tt plt}}{../dbag/plt-1.htm} is a highly capable
plotting package freely available from
\htmladdnormallink{{\tt www.physionet.org};}{http://www.physionet.org/}
...
applications included in this package.  The W3C's {\tt libwww} libraries
are optional but recommended;  they are necessary if you wish to use \WAVE{}
to read data directly from web and FTP servers.
...
the Linux version of XView (freely available from
\htmladdnormallink{PhysioNet}{http://www.physionet.org/physiotools/xview/},
...
Nevertheless, porting XView is likely to require significant effort.
...
downloaded from \htmladdnormallink{PhysioNet}{http://www.physionet.org/}.)
...
\htmladdnormallink{{\tt snip}}{../dbag/snip-1.htm}, or a web browser).  Check
\htmladdnormallink{PhysioNet}{http://www.physionet.org/} for updates to \WAVE{}
...
\htmladdnormallink{{\tt edf2mit}}{http://www.physionet.org/}, may be
...
Guide, available from Darwin Open Systems, \htmladdnormallink{{\tt
http://www.darwinsys.com/}}{http://www.darwinsys.com/}).  Unfortunately, the
...
\htmladdnormallink
{{\tt http://www.physio\-net.\-org\-/physiotools\-/wug/}}
{http://www.physionet.org/physiotools/wug/}
otherwise).
