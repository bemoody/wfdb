...
s/<A HREF="    cc-1.htm">cc<\/I>(1)<\/A>/cc<\/I>(1)/g
s/<A HREF="   gcc-1.htm">gcc<\/I>(1)<\/A>/gcc<\/I>(1)/g
s/<A HREF="    ld-1.htm">ld<\/I>(1)<\/A>/ld<\/I>(1)/g
s/<A HREF=" scanf-3.htm">scanf<\/I>(3)<\/A>/scanf<\/I>(3)/g
s/<A HREF=" fseek-3.htm">fseek<\/I>(3)<\/A>/fseek<\/I>(3)/g
s/<A HREF="gnuplot-1.htm">gnuplot<\/I>(1)<\/A>/gnuplot<\/I>(1)/g
s/<A HREF="  plot-1.htm">plot<\/I>(1)<\/A>/plot<\/I>(1)/g
s/<A HREF="  plot-3.htm">plot<\/I>(3)<\/A>/plot<\/I>(3)/g
s/<A HREF="     X-1.htm">X<\/I>(1)<\/A>/X<\/I>(1)/g
s/<A HREF="    sh-1.htm">sh<\/I>(1)<\/A>/sh<\/I>(1)/g
s/<A HREF=" xview-1.htm">xview<\/I>(1)<\/A>/xview<\/I>(1)/g
s/<A HREF="     F-n.htm">F(n)<\/I><\/A>/F(n)<\/I>/g
s/<A HREF="     F-n.htm">F(n)<\/A>/F(n)/g
s/<A HREF="osigfopen-n.htm">osigfopen(nsig)<\/A>/osigfopen(nsig)/g
s/<A HREF="     N-1.htm">N (1)<\/A>/N (1)/g
s/<A HREF="     N-2.htm">N (2)<\/A>/N (2)/g
...
s/<\/UL>\n<\/BODY>/<\/UL>\n<P><BR><HR><P><I><ADDRESS>\n<A HREF="mailto:george@mit.edu">George B. Moody (<tt>george@mit.edu<\tt>)<\/A>\n<\/ADDRESS><\I>\n<\/BODY>/
s/<BODY>/<BODY bgcolor="#FFFFFF"><A HREF="dbag.htm">WFDB Applications Guide<\/A>/
