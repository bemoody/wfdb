...
sizes of individual signals if you wish.  If the Annotation Template window
...
(to reset the size of the signal to its default (calibrated) value).
...
\index{zoom}
\index{enlarging signals}\index{signal!enlarging}
\index{reducing size of signals}
\index{changing scales}\index{scales!changing}
\index{rescaling}
\index{time axis!compressing and expanding}
