...
\index{GTKWave} Since version 1, \WAVE{} has used the XView toolkit,
...
available at
\htmladdnormallink{http://www\-.physio\-net\-.org/physio\-tools/\-beta/\-gtkwave/}
...
\begin{figure}[h]
\centerline{\epsfig{file=GTKWave}}
...
page on PhysioNet
(\htmladdnormallink{http://www\-.physio\-net.org/\-physio\-tools/\-beta/\-gtkwave/\-notes\-.shtml}
...
-remote} option is used by Mozilla, Netscape, and Opera; other browsers will
...
\index{Mozilla}\index{Netscape}\index{Opera}\index{web browser}
...
\htmladdnormallink{{\tt calsig(1)}}{../wag/calibr-1.htm},
in the
\htmladdnormallink{{\it WFDB Applications Guide}}{../wag/wag.htm}.
